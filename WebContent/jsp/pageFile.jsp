...
<body> 
<%--分页显示的开始 --%>
    	<div style="width:680px;margin:0 auto;margin-top:50px;text-align: center;">
    	<ul class="pagination" style="text-align:center; margin-top:10px;">
    		<li><a href="${pageContext.request.contextPath}/${page.url}&num=1">首页</a></li>
    		
    		<c:if test="${page.currentPageNum != 1}">
    			<li><a href="${pageContext.request.contextPath}/${page.url}&num=${page.prePageNum}">上一页</a></li>
    		</c:if>
    		...
    		<c:forEach begin="${page.startPage}" end="${page.endPage}" var="pagenum">
    		   <c:if test="${page.currentPageNum==pagenum}">
    		   		<li><a style="color: black;">${pagenum}</a></li>
    		   </c:if>
    		   <c:if test="${page.currentPageNum!=pagenum}">
    		...
    		<c:if test="${page.currentPageNum != page.totalPageNum}">
    			<li><a href="${pageContext.request.contextPath}/${page.url}&num=${page.nextPageNum}">下一页</a></li>
    		</c:if>
